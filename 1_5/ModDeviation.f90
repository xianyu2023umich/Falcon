Module ModDeviation
    ...
    function ModDeviation_1st_O4(f,ni,nj,nk,ng,dxi,dxj,dxk,direction,geometry) result(df_dx)
    ...
    end function ModDeviation_1st_O4

    function ModDeviation_1st_O2(f,ni,nj,nk,ng,dxi,dxj,dxk,direction,geometry) result(df_dx)
        implicit none
        integer,intent(in) :: ni,nj,nk,ng,direction
        real,intent(in) :: f(-ng+1:ni+ng,-ng+1:nj+ng,-ng+1:nk+ng)
        real,intent(in) :: dxi,dxj,dxk
    ...
    end function ModDeviation_1st_O2

    function ModDeviation_2D_O4(f,ni,nj,nk,ng,dxi,dxj,dxk,direction1,direction2,geometry) result(d2f_dx_dy)
        implicit none
    ...
    end function ModDeviation_2D_O4

    function ModDeviation_2nd_O3(f,ni,nj,nk,ng,dxi,dxj,dxk,direction,geometry) result(d2f_dx2)
        implicit none
        integer,intent(in) :: ni,nj,nk,ng,direction
        real,intent(in) :: f(-ng+1:ni+ng,-ng+1:nj+ng,-ng+1:nk+ng)
        real,intent(in) :: dxi,dxj,dxk
    ...
    end function ModDeviation_2nd_O3
