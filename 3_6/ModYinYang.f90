module ModYinYang
    ...
    function ModYinYang_CoordConv_0D(rtp_in) result(rtp_out)
        implicit none
        real(8),intent(in)  ::  rtp_in(3)       ! input
        real(8)             ::  rtp_out(3)      ! output
    ...
    function ModYinYang_CoordConv_1D(rtp_in,n) result(rtp_out)
        implicit none
        real(8),intent(in)  ::  rtp_in(n,3)     ! input
        integer,intent(in)  ::  n               ! num of points
        real(8)             ::  rtp_out(n,3)    ! output
    ...
    function ModYinYang_VecConv_0D(rtp_in,vec_in) result(vec_out)
        implicit none
        real(8),intent(in)  ::  rtp_in(3)       ! input coord
        real(8),intent(in)  ::  vec_in(3)       ! input vector
        real(8)             ::  rtp_out(3)      ! output coord
        real(8)             ::  vec_out(3)      ! output vector
    ...
    function ModYinYang_VecConv_1D(rtp_in,vec_in,n) result(vec_out)
        implicit none
        real(8),intent(in)  ::  rtp_in(n,3)   ! input coord
        real(8),intent(in)  ::  vec_in(n,3)   ! input vector
        integer,intent(in)  ::  n
        real(8)             ::  rtp_out(n,3)  ! output coord
        real(8)             ::  vec_out(n,3)  ! output vector
    ...
    function ModYinYang_GetOtherRange(rtp_range_in) result(rtp_range_out)
        implicit none
        real(8)             ::  rtp_range_in(3,2)
        real(8)             ::  rtp_corner_out(3),tp_corners_out(2,2,2)
        real(8)             ::  rtp_range_out(3,2)
        integer             ::  it,ip
