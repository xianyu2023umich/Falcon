module ModSaveLog
    ...
    subroutine ModSaveLog_OneLayer_SingleBlock(Block1, Log1)
        ...
        real(8)                 ::  T0,p0,rho0,s1,rho1,&
                                    enthalpy1,enthalpy2,dS,&
                                    gamma3,vrms,vrrms
        ...
        do ir=1,Log1%nr_SaveLog
            if (Log1%r_list_SaveLog(ir)>=Block1%xijk_range(1,1) .and. &
                ...
                case('rho1')
                    ! This is the average rho1 at this r.
                    ! get position index of this r in xi_I
                    ir_pos_int=floor((r-Block1%xi_I(1))/Block1%dxi)+1
                    ...
                    do j=1,nj
                        do k=1,nk
                            ! First get rho1
                            rho1 = &
                            Block1%primitive_IV(ir_pos_int,j,k,Block1%rho1_)*(1.0d0-weight)+&
                            Block1%primitive_IV(ir_pos_int+1,j,k,Block1%rho1_)*weight
                ...
                case('vrrms')
                    ...
                    do j=1,nj
                        do k=1,nk
                            ...
                            vrrms = abs(primitive_I(Block1%vr_))
