module ModLinReconstruct
    ...
    subroutine ModLinReconstruct_minmod(nvars,ni,nj,nk,ng,direction,u,d_u)
        ...
        real(8),intent(in)      ::  u(-ng+1:ni+ng,-ng+1:nj+ng,-ng+1:nk+ng,nvars)
        real(8),intent(out)     ::  d_u(-ng+2:ni+ng-1,-ng+2:nj+ng-1,-ng+2:nk+ng-1,nvars)
        real(8)                 ::  u_l(-ng+2:ni+ng-1,-ng+2:nj+ng-1,-ng+2:nk+ng-1,nvars),&
