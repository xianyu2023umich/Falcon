module ModWaveSpeed
    ...
    subroutine ModWaveSpeed_Dynamo_HD(Block1)
        implicit none
    ...
    end subroutine ModWaveSpeed_Dynamo_HD

    subroutine ModWaveSpeed_Dynamo_MHD(Block1)
        implicit none
        type(BlockType), intent(inout) :: Block1
    ...
    end subroutine ModWaveSpeed_Dynamo_MHD
